  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      ...
      >
        ...
        <div className="mb-6 p-4 rounded-2xl bg-black/40 border border-white/5 flex flex-col gap-3">
        ...
        {roomId ? (
          <div className="flex flex-col gap-4">
            ...
            <div className="p-4 rounded-2xl bg-theme-primary/[0.07] border border-theme-primary/30 flex items-center justify-between">
              <div>
                <span className="text-[10px] font-mono text-theme-primary uppercase tracking-widest block font-semibold">
                  Active Room Code
                </span>
            ...
            <div className="p-3.5 rounded-xl bg-white/5 border border-white/5 text-[11px] font-mono text-slate-400 leading-relaxed">
              <span className="text-cyber-lime font-bold">💡 Multi-Tab Racing:</span> Open this application in a second browser window or tab, join room code <span className="text-white font-bold">{roomId}</span>, and race against each other with real-time peer synchronization!
            </div>
